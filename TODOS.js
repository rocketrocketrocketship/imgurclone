...
// 2. Restructuring node '/upload' route. Right now saving to amazon and to database in the same function. Should be split up ---DONE---
...
// 	5.2 when user adds more than 1 photo, then should save it to the Album collection ---DONE---
// 	...
